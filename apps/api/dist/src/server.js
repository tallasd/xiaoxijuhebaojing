...
import { ChatSpeaker, MessageStatus, QualityAlertStatus, RiskLevel } from "@prisma/client";
import { z } from "zod";
import { ingestMessage, messageInclude, normalizeSourceType, serializeMessage } from "./domain.js";
...
app.get("/api/dashboard", async (_req, res) => {
    ...
    const [todayTotal, openTotal, p0Total, timeoutTotal, onlineCollectors, offlineCollectors, byPlatform] = await Promise.all([
